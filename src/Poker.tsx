...
const Player = ({ user }: { user: User }) => {
  return (
    <div className="flex items-center gap-4 rounded border bg-white p-4 shadow-2xl">
...
const Poker = ({ children, user, users }: React.PropsWithChildren & { user: User | null; users: User[] }) => {
  ...
  return (
    <div className="grid h-full grid-cols-[1fr_2fr_1fr] grid-rows-[1fr_3fr_3fr] items-center gap-32 p-4">
      <div></div>
